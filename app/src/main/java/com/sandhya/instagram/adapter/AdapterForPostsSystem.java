...
import com.sandhya.instagram.model.SystemModelForUsers;
import com.sandhya.instagram.notification.Data;
import com.sandhya.instagram.notification.Sender;
import com.sandhya.instagram.notification.Token;
            ...
            mRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    new StyleableToast
                            ...
                            .length(2000)
                            .solidBackground()
                            .backgroundColor(context.getResources().getColor(R.color.btnFollow))
                            .show();
                }
            });
        }
